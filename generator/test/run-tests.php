<?php
    ...
    require_once 'classes/propel/util/CriteriaTest.php';
    ...
    require_once 'classes/propel/engine/database/model/TableTest.php';
    $modelSuite->addTestSuite(new ReflectionClass('TableTest'));

    require_once 'classes/propel/engine/database/model/NameFactoryTest.php';
