...
try {
    ...
    print "Making sure 3 validation messages were returned: ";      
    print boolTest(count($ret2) === 3);  
    
    print "Making sure correct columns failed: ";      
    print boolTest(array_keys($ret2) === array('author.LAST_NAME', 'book.TITLE', 'review.REVIEWED_BY'));  
