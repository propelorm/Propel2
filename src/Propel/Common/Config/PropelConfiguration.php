                        ...
                        ->arrayNode('adapters')
                            ...
                            ->children()
                                ->arrayNode('mysql')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('tableType')->defaultValue('InnoDB')->end()
                    ...
                    ->children()
                        ...
                        ->arrayNode('dateTime')
                            ...
                            ->children()
                                ...
                                ->scalarNode('defaultTimeStampFormat')->defaultValue('Y-m-d H:i:s')->end()
                                ->scalarNode('defaultTimeFormat')->defaultValue(' %X ')->end()
                                ->scalarNode('defaultDateFormat')->defaultValue(' %x ')->end()
                            ->end()
                        ->end()
                        ->arrayNode('objectModel')
                            ...
                            ->children()
                                ...
                                ->arrayNode('builders')
                                    ->addDefaultsIfNotSet()
                                    ->children()
                                        ->scalarNode('object')->defaultValue('\Propel\Generator\Builder\Om\ObjectBuilder')->end()
                                        ->scalarNode('objectstub')->defaultValue('\Propel\Generator\Builder\Om\ExtensionObjectBuilder')->end()
                                        ->scalarNode('objectmultiextend')->defaultValue('\Propel\Generator\Builder\Om\MultiExtendObjectBuilder')->end()
                                        ->scalarNode('query')->defaultValue('\Propel\Generator\Builder\Om\QueryBuilder')->end()
                                        ->scalarNode('querystub')->defaultValue('\Propel\Generator\Builder\Om\ExtensionQueryBuilder')->end()
                                        ->scalarNode('queryinheritance')->defaultValue('\Propel\Generator\Builder\Om\QueryInheritanceBuilder')->end()
                                        ->scalarNode('queryinheritancestub')->defaultValue('\Propel\Generator\Builder\Om\ExtensionQueryInheritanceBuilder')->end()
                                        ->scalarNode('tablemap')->defaultValue('\Propel\Generator\Builder\Om\TableMapBuilder')->end()
                                        ->scalarNode('interface')->defaultValue('\Propel\Generator\Builder\Om\InterfaceBuilder')->end()
                                        ->scalarNode('datasql')->end()
                                    ->end()
                                ->end()
                            ->end()
                        ->end() //objectModel
