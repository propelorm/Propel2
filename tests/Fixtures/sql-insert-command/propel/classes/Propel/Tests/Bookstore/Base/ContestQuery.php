...
/**
 * Base class that represents a query for the 'contest' table.
 *
 *
 *
 * @method     ChildContestQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildContestQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildContestQuery groupById() Group by the id column
 * @method     ChildContestQuery groupByName() Group by the name column
 *
 ...
 *
 * @method     ChildContestQuery leftJoinBookstoreContest($relationAlias = null) Adds a LEFT JOIN clause to the query using the BookstoreContest relation
 * @method     ChildContestQuery rightJoinBookstoreContest($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BookstoreContest relation
 * @method     ChildContestQuery innerJoinBookstoreContest($relationAlias = null) Adds a INNER JOIN clause to the query using the BookstoreContest relation
 *
 * @method     \Propel\Tests\Bookstore\BookstoreContestQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildContest findOneById(int $id) Return the first ChildContest filtered by the id column
 * @method     ChildContest findOneByName(string $name) Return the first ChildContest filtered by the name column
 *
 ...
 * @method     ChildContest[]|ObjectCollection findById(int $id) Return ChildContest objects filtered by the id column
 * @method     ChildContest[]|ObjectCollection findByName(string $name) Return ChildContest objects filtered by the name column
...
abstract class ContestQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Tests\Bookstore\Base\ContestQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\Contest', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ContestTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT ID, NAME FROM contest WHERE ID = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ContestTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ContestTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ContestTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ContestTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ContestTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ContestTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ContestTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByBookstoreContest($bookstoreContest, $comparison = null)
    {
        if ($bookstoreContest instanceof \Propel\Tests\Bookstore\BookstoreContest) {
            return $this
                ->addUsingAlias(ContestTableMap::COL_ID, $bookstoreContest->getContestId(), $comparison);
    ...
    {
        if ($contest) {
            $this->addUsingAlias(ContestTableMap::COL_ID, $contest->getId(), Criteria::NOT_EQUAL);
        }
