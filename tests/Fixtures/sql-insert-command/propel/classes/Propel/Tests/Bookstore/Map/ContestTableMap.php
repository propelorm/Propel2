...
class ContestTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.ContestTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Contest';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Contest';
     ...
     */
    const COL_ID = 'contest.ID';

    /**
     * the column name for the NAME field
     */
    const COL_NAME = 'contest.NAME';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ContestTableMap::COL_ID, ContestTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ContestTableMap::COL_ID => 0, ContestTableMap::COL_NAME => 1, ),
    ...
    {
        $this->addRelation('BookstoreContest', '\\Propel\\Tests\\Bookstore\\BookstoreContest', RelationMap::ONE_TO_MANY, array('id' => 'contest_id', ), 'CASCADE', null, 'BookstoreContests');
    } // buildRelations()
    /**
