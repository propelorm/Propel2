...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Book';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID, BookTableMap::COL_TITLE, BookTableMap::COL_ISBN, BookTableMap::COL_PRICE, BookTableMap::COL_PUBLISHER_ID, BookTableMap::COL_AUTHOR_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(BookTableMap::COL_ID => 0, BookTableMap::COL_TITLE => 1, BookTableMap::COL_ISBN => 2, BookTableMap::COL_PRICE => 3, BookTableMap::COL_PUBLISHER_ID => 4, BookTableMap::COL_AUTHOR_ID => 5, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Tests\\Bookstore\\Book');
    ...
    {
        $this->addRelation('Publisher', '\\Propel\\Tests\\Bookstore\\Publisher', RelationMap::MANY_TO_ONE, array('publisher_id' => 'id', ), 'SET NULL', null);
        $this->addRelation('Author', '\\Propel\\Tests\\Bookstore\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), 'SET NULL', 'CASCADE');
        $this->addRelation('BookSummary', '\\Propel\\Tests\\Bookstore\\BookSummary', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'BookSummaries');
        $this->addRelation('Review', '\\Propel\\Tests\\Bookstore\\Review', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'Reviews');
        $this->addRelation('Media', '\\Propel\\Tests\\Bookstore\\Media', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'Medias');
        $this->addRelation('BookListRel', '\\Propel\\Tests\\Bookstore\\BookListRel', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'BookListRels');
        $this->addRelation('BookListFavorite', '\\Propel\\Tests\\Bookstore\\BookListFavorite', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'BookListFavorites');
        $this->addRelation('BookOpinion', '\\Propel\\Tests\\Bookstore\\BookOpinion', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'BookOpinions');
        $this->addRelation('ReaderFavorite', '\\Propel\\Tests\\Bookstore\\ReaderFavorite', RelationMap::ONE_TO_MANY, array('id' => 'book_id', ), 'CASCADE', null, 'ReaderFavorites');
        $this->addRelation('BookstoreContest', '\\Propel\\Tests\\Bookstore\\BookstoreContest', RelationMap::ONE_TO_MANY, array('id' => 'prize_book_id', ), 'SET NULL', null, 'BookstoreContests');
        $this->addRelation('BookClubList', '\\Propel\\Tests\\Bookstore\\BookClubList', RelationMap::MANY_TO_MANY, array(), 'CASCADE', null, 'BookClubLists');
        $this->addRelation('FavoriteBookClubList', '\\Propel\\Tests\\Bookstore\\BookClubList', RelationMap::MANY_TO_MANY, array(), 'CASCADE', null, 'FavoriteBookClubLists');
    } // buildRelations()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Tests\Bookstore\Book) { // it's a model object
