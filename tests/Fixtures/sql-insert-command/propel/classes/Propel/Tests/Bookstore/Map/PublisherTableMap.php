...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Publisher';
     ...
     */
    const DEFAULT_STRING_FORMAT = 'XML';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Tests\\Bookstore\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\Propel\\Tests\\Bookstore\\Book', RelationMap::ONE_TO_MANY, array('id' => 'publisher_id', ), 'SET NULL', null, 'Books');
        $this->addRelation('BookstoreSale', '\\Propel\\Tests\\Bookstore\\BookstoreSale', RelationMap::ONE_TO_MANY, array('id' => 'publisher_id', ), 'SET NULL', null, 'BookstoreSales');
    } // buildRelations()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Tests\Bookstore\Publisher) { // it's a model object
