...
abstract class Customer implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\CustomerTableMap';
    ...
    /**
     * Initializes internal state of Propel\Tests\Bookstore\Base\Customer object.
     */
    ...
    public function getJoinDate($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->join_date instanceof \DateTime ? $this->join_date->format($format) : null;
        }
    }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CustomerTableMap::translateFieldName('JoinDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Tests\\Bookstore\\Customer'), 0, $e);
        }
    }
     ...
     * @return $this|\Propel\Tests\Bookstore\Customer The current object (for fluent API support)
     */
    ...
    public function setJoinDate($v)
    {
        ...
        if ($this->join_date !== null || $dt !== null) {
            if ($dt !== $this->join_date) {
                $this->join_date = $dt;
                $this->modifiedColumns[CustomerTableMap::COL_JOIN_DATE] = true;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CustomerTableMap::COL_JOIN_DATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'NAME':
                        ...
                        break;
                    case 'JOIN_DATE':
                        $stmt->bindValue($identifier, $this->join_date ? $this->join_date->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Bookstore\Customer
     */
     ...
     *
     * @return $this|\Propel\Tests\Bookstore\Customer The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CustomerTableMap::COL_JOIN_DATE)) {
            $criteria->add(CustomerTableMap::COL_JOIN_DATE, $this->join_date);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Tests\Bookstore\Customer (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Tests\Bookstore\Customer Clone of current object.
     * @throws PropelException
     */
    ...
    public function setBookstoreContestEntries(Collection $bookstoreContestEntries, ConnectionInterface $con = null)
    {
        ...
        foreach ($bookstoreContestEntriesToDelete as $bookstoreContestEntryRemoved) {
            $bookstoreContestEntryRemoved->setCustomer(null);
        }
    ...
    protected function doAddBookstoreContestEntry(ChildBookstoreContestEntry $bookstoreContestEntry)
    {
        ...
        $bookstoreContestEntry->setCustomer($this);
    }
    ...
    public function removeBookstoreContestEntry(ChildBookstoreContestEntry $bookstoreContestEntry)
    {
        if ($this->getBookstoreContestEntries()->contains($bookstoreContestEntry)) {
            ...
            $bookstoreContestEntry->setCustomer(null);
        }
