...
class Table1TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.Table1TableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\Table1';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.Table1';
     ...
     */
    const COL_ID = 'table1.ID';

    /**
     * the column name for the TITLE field
     */
    const COL_TITLE = 'table1.TITLE';

    /**
     * the column name for the CREATED_ON field
     */
    const COL_CREATED_ON = 'table1.CREATED_ON';

    /**
     * the column name for the UPDATED_ON field
     */
    const COL_UPDATED_ON = 'table1.UPDATED_ON';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'CreatedOn', 'UpdatedOn', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'title', 'createdOn', 'updatedOn', ),
        self::TYPE_COLNAME       => array(Table1TableMap::COL_ID, Table1TableMap::COL_TITLE, Table1TableMap::COL_CREATED_ON, Table1TableMap::COL_UPDATED_ON, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_TITLE', 'COL_CREATED_ON', 'COL_UPDATED_ON', ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'created_on', 'updated_on', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'CreatedOn' => 2, 'UpdatedOn' => 3, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'title' => 1, 'createdOn' => 2, 'updatedOn' => 3, ),
        self::TYPE_COLNAME       => array(Table1TableMap::COL_ID => 0, Table1TableMap::COL_TITLE => 1, Table1TableMap::COL_CREATED_ON => 2, Table1TableMap::COL_UPDATED_ON => 3, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_TITLE' => 1, 'COL_CREATED_ON' => 2, 'COL_UPDATED_ON' => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'created_on' => 2, 'updated_on' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    {
        return array(
            'timestampable' => array('create_column' => 'created_on', 'update_column' => 'updated_on', 'disable_created_at' => 'false', 'disable_updated_at' => 'false', ),
        );
    } // getBehaviors()
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(Table1TableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(Table1TableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new Table1TableMap());
        }
    }
