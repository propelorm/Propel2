...
class BookstoreSaleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookstoreSaleTableMap';
     ...
     */
    const TABLE_NAME = 'bookstore_sale';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\BookstoreSale';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.BookstoreSale';
     ...
     */
    const COL_ID = 'bookstore_sale.ID';

    /**
     * the column name for the BOOKSTORE_ID field
     */
    const COL_BOOKSTORE_ID = 'bookstore_sale.BOOKSTORE_ID';

    /**
     * the column name for the PUBLISHER_ID field
     */
    const COL_PUBLISHER_ID = 'bookstore_sale.PUBLISHER_ID';

    /**
     * the column name for the SALE_NAME field
     */
    const COL_SALE_NAME = 'bookstore_sale.SALE_NAME';

    /**
     * the column name for the DISCOUNT field
     */
    const COL_DISCOUNT = 'bookstore_sale.DISCOUNT';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'BookstoreId', 'PublisherId', 'SaleName', 'Discount', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'bookstoreId', 'publisherId', 'saleName', 'discount', ),
        self::TYPE_COLNAME       => array(BookstoreSaleTableMap::COL_ID, BookstoreSaleTableMap::COL_BOOKSTORE_ID, BookstoreSaleTableMap::COL_PUBLISHER_ID, BookstoreSaleTableMap::COL_SALE_NAME, BookstoreSaleTableMap::COL_DISCOUNT, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_BOOKSTORE_ID', 'COL_PUBLISHER_ID', 'COL_SALE_NAME', 'COL_DISCOUNT', ),
        self::TYPE_FIELDNAME     => array('id', 'bookstore_id', 'publisher_id', 'sale_name', 'discount', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'BookstoreId' => 1, 'PublisherId' => 2, 'SaleName' => 3, 'Discount' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'bookstoreId' => 1, 'publisherId' => 2, 'saleName' => 3, 'discount' => 4, ),
        self::TYPE_COLNAME       => array(BookstoreSaleTableMap::COL_ID => 0, BookstoreSaleTableMap::COL_BOOKSTORE_ID => 1, BookstoreSaleTableMap::COL_PUBLISHER_ID => 2, BookstoreSaleTableMap::COL_SALE_NAME => 3, BookstoreSaleTableMap::COL_DISCOUNT => 4, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_BOOKSTORE_ID' => 1, 'COL_PUBLISHER_ID' => 2, 'COL_SALE_NAME' => 3, 'COL_DISCOUNT' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'bookstore_id' => 1, 'publisher_id' => 2, 'sale_name' => 3, 'discount' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(BookstoreSaleTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(BookstoreSaleTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new BookstoreSaleTableMap());
        }
    }
...
} // BookstoreSaleTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BookstoreSaleTableMap::buildTableMap();
