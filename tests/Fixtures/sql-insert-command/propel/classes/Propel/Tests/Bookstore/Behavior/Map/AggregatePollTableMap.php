...
class AggregatePollTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.AggregatePollTableMap';
     ...
     */
    const TABLE_NAME = 'aggregate_poll';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\AggregatePoll';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.AggregatePoll';
     ...
     */
    const COL_ID = 'aggregate_poll.ID';

    /**
     * the column name for the TOTAL_SCORE field
     */
    const COL_TOTAL_SCORE = 'aggregate_poll.TOTAL_SCORE';

    /**
     * the column name for the NB_VOTES field
     */
    const COL_NB_VOTES = 'aggregate_poll.NB_VOTES';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'TotalScore', 'NbVotes', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'totalScore', 'nbVotes', ),
        self::TYPE_COLNAME       => array(AggregatePollTableMap::COL_ID, AggregatePollTableMap::COL_TOTAL_SCORE, AggregatePollTableMap::COL_NB_VOTES, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_TOTAL_SCORE', 'COL_NB_VOTES', ),
        self::TYPE_FIELDNAME     => array('id', 'total_score', 'nb_votes', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'TotalScore' => 1, 'NbVotes' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'totalScore' => 1, 'nbVotes' => 2, ),
        self::TYPE_COLNAME       => array(AggregatePollTableMap::COL_ID => 0, AggregatePollTableMap::COL_TOTAL_SCORE => 1, AggregatePollTableMap::COL_NB_VOTES => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_TOTAL_SCORE' => 1, 'COL_NB_VOTES' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'total_score' => 1, 'nb_votes' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('AggregateItem', '\\Propel\\Tests\\Bookstore\\Behavior\\AggregateItem', RelationMap::ONE_TO_MANY, array('id' => 'poll_id', ), 'SET NULL', 'CASCADE', 'AggregateItems');
    } // buildRelations()
    ...
    {
        return array(
            'aggregate_total_score' => array('name' => 'total_score', 'expression' => 'SUM(score)', 'condition' => '', 'foreign_table' => 'aggregate_item', 'foreign_schema' => '', ),
            'aggregate_nb_votes' => array('name' => 'nb_votes', 'expression' => 'COUNT(score)', 'condition' => '', 'foreign_table' => 'aggregate_item', 'foreign_schema' => '', ),
        );
    } // getBehaviors()
    /**
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(AggregatePollTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(AggregatePollTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new AggregatePollTableMap());
        }
    }
...
} // AggregatePollTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
AggregatePollTableMap::buildTableMap();
