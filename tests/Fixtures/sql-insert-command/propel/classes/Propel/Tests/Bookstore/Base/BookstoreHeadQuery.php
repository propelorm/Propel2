 ...
 *
 */
class BookstoreHeadQuery extends BookstoreManagerQuery
{

    /**
     * Returns a new \Propel\Tests\Bookstore\BookstoreHeadQuery object.
     *
    ...
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        ...
        $query = new \Propel\Tests\Bookstore\BookstoreHeadQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only BookstoreHead objects.
     */
    public function preSelect(ConnectionInterface $con)
    {
        $this->addUsingAlias(BookstoreEmployeeTableMap::COL_CLASS_KEY, BookstoreEmployeeTableMap::CLASSKEY_3);
    }
     ...
     * Having the BookstoreHead class.
