...
class BookstoreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.BookstoreTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Bookstore';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Bookstore';
     ...
     */
    const COL_ID = 'bookstore.ID';

    /**
     * the column name for the STORE_NAME field
     */
    const COL_STORE_NAME = 'bookstore.STORE_NAME';

    /**
     * the column name for the LOCATION field
     */
    const COL_LOCATION = 'bookstore.LOCATION';

    /**
     * the column name for the POPULATION_SERVED field
     */
    const COL_POPULATION_SERVED = 'bookstore.POPULATION_SERVED';

    /**
     * the column name for the TOTAL_BOOKS field
     */
    const COL_TOTAL_BOOKS = 'bookstore.TOTAL_BOOKS';

    /**
     * the column name for the STORE_OPEN_TIME field
     */
    const COL_STORE_OPEN_TIME = 'bookstore.STORE_OPEN_TIME';

    /**
     * the column name for the WEBSITE field
     */
    const COL_WEBSITE = 'bookstore.WEBSITE';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'StoreName', 'Location', 'PopulationServed', 'TotalBooks', 'StoreOpenTime', 'Website', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'storeName', 'location', 'populationServed', 'totalBooks', 'storeOpenTime', 'website', ),
        self::TYPE_COLNAME       => array(BookstoreTableMap::COL_ID, BookstoreTableMap::COL_STORE_NAME, BookstoreTableMap::COL_LOCATION, BookstoreTableMap::COL_POPULATION_SERVED, BookstoreTableMap::COL_TOTAL_BOOKS, BookstoreTableMap::COL_STORE_OPEN_TIME, BookstoreTableMap::COL_WEBSITE, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_STORE_NAME', 'COL_LOCATION', 'COL_POPULATION_SERVED', 'COL_TOTAL_BOOKS', 'COL_STORE_OPEN_TIME', 'COL_WEBSITE', ),
        self::TYPE_FIELDNAME     => array('id', 'store_name', 'location', 'population_served', 'total_books', 'store_open_time', 'website', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'StoreName' => 1, 'Location' => 2, 'PopulationServed' => 3, 'TotalBooks' => 4, 'StoreOpenTime' => 5, 'Website' => 6, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'storeName' => 1, 'location' => 2, 'populationServed' => 3, 'totalBooks' => 4, 'storeOpenTime' => 5, 'website' => 6, ),
        self::TYPE_COLNAME       => array(BookstoreTableMap::COL_ID => 0, BookstoreTableMap::COL_STORE_NAME => 1, BookstoreTableMap::COL_LOCATION => 2, BookstoreTableMap::COL_POPULATION_SERVED => 3, BookstoreTableMap::COL_TOTAL_BOOKS => 4, BookstoreTableMap::COL_STORE_OPEN_TIME => 5, BookstoreTableMap::COL_WEBSITE => 6, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_STORE_NAME' => 1, 'COL_LOCATION' => 2, 'COL_POPULATION_SERVED' => 3, 'COL_TOTAL_BOOKS' => 4, 'COL_STORE_OPEN_TIME' => 5, 'COL_WEBSITE' => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'store_name' => 1, 'location' => 2, 'population_served' => 3, 'total_books' => 4, 'store_open_time' => 5, 'website' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        $this->addRelation('BookstoreSale', '\\Propel\\Tests\\Bookstore\\BookstoreSale', RelationMap::ONE_TO_MANY, array('id' => 'bookstore_id', ), 'CASCADE', null, 'BookstoreSales');
        $this->addRelation('BookstoreContest', '\\Propel\\Tests\\Bookstore\\BookstoreContest', RelationMap::ONE_TO_MANY, array('id' => 'bookstore_id', ), 'CASCADE', null, 'BookstoreContests');
        $this->addRelation('BookstoreContestEntry', '\\Propel\\Tests\\Bookstore\\BookstoreContestEntry', RelationMap::ONE_TO_MANY, array('id' => 'bookstore_id', ), 'CASCADE', null, 'BookstoreContestEntries');
    } // buildRelations()
    /**
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(BookstoreTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(BookstoreTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new BookstoreTableMap());
        }
    }
...
//
BookstoreTableMap::buildTableMap();
