...
class ConcreteQuizzQuestionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.ConcreteQuizzQuestionTableMap';
     ...
     */
    const TABLE_NAME = 'concrete_quizz_question';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\ConcreteQuizzQuestion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.ConcreteQuizzQuestion';
     ...
     */
    const COL_ID = 'concrete_quizz_question.ID';

    /**
     * the column name for the QUESTION field
     */
    const COL_QUESTION = 'concrete_quizz_question.QUESTION';

    /**
     * the column name for the ANSWER_1 field
     */
    const COL_ANSWER_1 = 'concrete_quizz_question.ANSWER_1';

    /**
     * the column name for the ANSWER_2 field
     */
    const COL_ANSWER_2 = 'concrete_quizz_question.ANSWER_2';

    /**
     * the column name for the CORRECT_ANSWER field
     */
    const COL_CORRECT_ANSWER = 'concrete_quizz_question.CORRECT_ANSWER';

    /**
     * the column name for the QUIZZ_ID field
     */
    const COL_QUIZZ_ID = 'concrete_quizz_question.QUIZZ_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Question', 'Answer1', 'Answer2', 'CorrectAnswer', 'QuizzId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'question', 'answer1', 'answer2', 'correctAnswer', 'quizzId', ),
        self::TYPE_COLNAME       => array(ConcreteQuizzQuestionTableMap::COL_ID, ConcreteQuizzQuestionTableMap::COL_QUESTION, ConcreteQuizzQuestionTableMap::COL_ANSWER_1, ConcreteQuizzQuestionTableMap::COL_ANSWER_2, ConcreteQuizzQuestionTableMap::COL_CORRECT_ANSWER, ConcreteQuizzQuestionTableMap::COL_QUIZZ_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_QUESTION', 'COL_ANSWER_1', 'COL_ANSWER_2', 'COL_CORRECT_ANSWER', 'COL_QUIZZ_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'question', 'answer_1', 'answer_2', 'correct_answer', 'quizz_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Question' => 1, 'Answer1' => 2, 'Answer2' => 3, 'CorrectAnswer' => 4, 'QuizzId' => 5, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'question' => 1, 'answer1' => 2, 'answer2' => 3, 'correctAnswer' => 4, 'quizzId' => 5, ),
        self::TYPE_COLNAME       => array(ConcreteQuizzQuestionTableMap::COL_ID => 0, ConcreteQuizzQuestionTableMap::COL_QUESTION => 1, ConcreteQuizzQuestionTableMap::COL_ANSWER_1 => 2, ConcreteQuizzQuestionTableMap::COL_ANSWER_2 => 3, ConcreteQuizzQuestionTableMap::COL_CORRECT_ANSWER => 4, ConcreteQuizzQuestionTableMap::COL_QUIZZ_ID => 5, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_QUESTION' => 1, 'COL_ANSWER_1' => 2, 'COL_ANSWER_2' => 3, 'COL_CORRECT_ANSWER' => 4, 'COL_QUIZZ_ID' => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'question' => 1, 'answer_1' => 2, 'answer_2' => 3, 'correct_answer' => 4, 'quizz_id' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->getColumn('QUESTION', false)->setPrimaryString(true);
    ...
    {
        $this->addRelation('ConcreteQuizz', '\\Propel\\Tests\\Bookstore\\Behavior\\ConcreteQuizz', RelationMap::MANY_TO_ONE, array('quizz_id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ConcreteQuizzQuestionTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ConcreteQuizzQuestionTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ConcreteQuizzQuestionTableMap());
        }
    }
...
} // ConcreteQuizzQuestionTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
ConcreteQuizzQuestionTableMap::buildTableMap();
