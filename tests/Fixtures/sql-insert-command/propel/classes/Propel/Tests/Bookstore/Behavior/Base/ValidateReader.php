...
abstract class ValidateReader implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Behavior\\Map\\ValidateReaderTableMap';
     ...
     *
     * @return $this|ValidateReader The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\Tests\Bookstore\Behavior\ValidateReader The current object (for fluent API support)
     */
    ...
    {
        if (isset($alreadyDumpedObjects['ValidateReader'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ValidateReader'][$this->getPrimaryKey()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Bookstore\Behavior\ValidateReader
     */
     ...
     *
     * @return $this|\Propel\Tests\Bookstore\Behavior\ValidateReader The current object, for fluid interface
     */
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildValidateReader The current object (for fluent API support)
     */
     ...
     * @return bool
     */
    public function isValidateBooksLoaded()
    {
    ...
    {
        if ($this->getValidateBooks()->contains($validateBook)) { $validateReaderBook = new ChildValidateReaderBook();
