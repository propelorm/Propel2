...
class ConcreteNewsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.ConcreteNewsTableMap';
     ...
     */
    const TABLE_NAME = 'concrete_news';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\ConcreteNews';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.ConcreteNews';
     ...
     */
    const COL_BODY = 'concrete_news.BODY';

    /**
     * the column name for the AUTHOR_ID field
     */
    const COL_AUTHOR_ID = 'concrete_news.AUTHOR_ID';

    /**
     * the column name for the ID field
     */
    const COL_ID = 'concrete_news.ID';

    /**
     * the column name for the TITLE field
     */
    const COL_TITLE = 'concrete_news.TITLE';

    /**
     * the column name for the CATEGORY_ID field
     */
    const COL_CATEGORY_ID = 'concrete_news.CATEGORY_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Body', 'AuthorId', 'Id', 'Title', 'CategoryId', ),
        self::TYPE_STUDLYPHPNAME => array('body', 'authorId', 'id', 'title', 'categoryId', ),
        self::TYPE_COLNAME       => array(ConcreteNewsTableMap::COL_BODY, ConcreteNewsTableMap::COL_AUTHOR_ID, ConcreteNewsTableMap::COL_ID, ConcreteNewsTableMap::COL_TITLE, ConcreteNewsTableMap::COL_CATEGORY_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_BODY', 'COL_AUTHOR_ID', 'COL_ID', 'COL_TITLE', 'COL_CATEGORY_ID', ),
        self::TYPE_FIELDNAME     => array('body', 'author_id', 'id', 'title', 'category_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Body' => 0, 'AuthorId' => 1, 'Id' => 2, 'Title' => 3, 'CategoryId' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('body' => 0, 'authorId' => 1, 'id' => 2, 'title' => 3, 'categoryId' => 4, ),
        self::TYPE_COLNAME       => array(ConcreteNewsTableMap::COL_BODY => 0, ConcreteNewsTableMap::COL_AUTHOR_ID => 1, ConcreteNewsTableMap::COL_ID => 2, ConcreteNewsTableMap::COL_TITLE => 3, ConcreteNewsTableMap::COL_CATEGORY_ID => 4, ),
        self::TYPE_RAW_COLNAME   => array('COL_BODY' => 0, 'COL_AUTHOR_ID' => 1, 'COL_ID' => 2, 'COL_TITLE' => 3, 'COL_CATEGORY_ID' => 4, ),
        self::TYPE_FIELDNAME     => array('body' => 0, 'author_id' => 1, 'id' => 2, 'title' => 3, 'category_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        $this->addRelation('ConcreteArticle', '\\Propel\\Tests\\Bookstore\\Behavior\\ConcreteArticle', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    ...
    {
        return array(
            'concrete_inheritance' => array('extends' => 'concrete_article', 'descendant_column' => 'descendant_class', 'copy_data_to_parent' => 'true', 'schema' => '', ),
        );
    } // getBehaviors()
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ConcreteNewsTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ConcreteNewsTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ConcreteNewsTableMap());
        }
    }
...
} // ConcreteNewsTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
ConcreteNewsTableMap::buildTableMap();
