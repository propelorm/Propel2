 ...
 *
 * @method     ChildTable3 findOne(ConnectionInterface $con = null) Return the first ChildTable3 matching the query
 ...
 *
 * @method     ChildTable3 findOneById(int $id) Return the first ChildTable3 filtered by the id column
 * @method     ChildTable3 findOneByTitle(string $title) Return the first ChildTable3 filtered by the title column
 * @method     ChildTable3 findOneByTest(string $test) Return the first ChildTable3 filtered by the test column
 *
 * @method     ChildTable3[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildTable3 objects based on current ModelCriteria
 * @method     ChildTable3[]|ObjectCollection findById(int $id) Return ChildTable3 objects filtered by the id column
 * @method     ChildTable3[]|ObjectCollection findByTitle(string $title) Return ChildTable3 objects filtered by the title column
 * @method     ChildTable3[]|ObjectCollection findByTest(string $test) Return ChildTable3 objects filtered by the test column
...
abstract class Table3Query extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\Table3', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = Table3TableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj = new ChildTable3();
            $obj->hydrate($row);
            Table3TableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildTable3Query The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(Table3TableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(Table3TableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(Table3TableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(Table3TableMap::COL_TITLE, $title, $comparison);
    }
    ...
    public function filterByTest($test = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(Table3TableMap::COL_TEST, $test, $comparison);
    }
