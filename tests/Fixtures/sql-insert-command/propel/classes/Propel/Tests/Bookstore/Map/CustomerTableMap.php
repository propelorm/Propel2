...
class CustomerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.CustomerTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Customer';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Customer';
     ...
     */
    const COL_JOIN_DATE = 'customer.JOIN_DATE';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'JoinDate', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'name', 'joinDate', ),
        self::TYPE_COLNAME       => array(CustomerTableMap::COL_ID, CustomerTableMap::COL_NAME, CustomerTableMap::COL_JOIN_DATE, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_NAME', 'COL_JOIN_DATE', ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'join_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'JoinDate' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'name' => 1, 'joinDate' => 2, ),
        self::TYPE_COLNAME       => array(CustomerTableMap::COL_ID => 0, CustomerTableMap::COL_NAME => 1, CustomerTableMap::COL_JOIN_DATE => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_NAME' => 1, 'COL_JOIN_DATE' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'join_date' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Tests\\Bookstore\\Customer');
    ...
    {
        $this->addRelation('BookstoreContestEntry', '\\Propel\\Tests\\Bookstore\\BookstoreContestEntry', RelationMap::ONE_TO_MANY, array('id' => 'customer_id', ), 'CASCADE', null, 'BookstoreContestEntries');
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CustomerTableMap::COL_JOIN_DATE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Tests\Bookstore\Customer) { // it's a model object
