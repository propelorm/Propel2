...
abstract class TypeObject implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Map\\TypeObjectTableMap';
     ...
     *
     * @return $this|TypeObject The current object, for fluid interface
     */
    ...
    public function getDetails()
    {
        if (null == $this->details_unserialized && is_resource($this->details)) {
            if ($serialisedString = stream_get_contents($this->details)) {
                $this->details_unserialized = unserialize($serialisedString);
            }
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = TypeObjectTableMap::NUM_HYDRATE_COLUMNS.
     ...
     * @return $this|\Propel\Tests\Bookstore\TypeObject The current object (for fluent API support)
     */
    ...
    {
        $pos = TypeObjectTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TypeObject'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TypeObject'][$this->getPrimaryKey()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Bookstore\TypeObject
     */
     ...
     *
     * @return $this|\Propel\Tests\Bookstore\TypeObject The current object, for fluid interface
     */
