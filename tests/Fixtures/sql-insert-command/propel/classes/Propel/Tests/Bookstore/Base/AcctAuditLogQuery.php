 ...
 *
 * @method     ChildAcctAuditLog findOne(ConnectionInterface $con = null) Return the first ChildAcctAuditLog matching the query
 ...
 *
 * @method     ChildAcctAuditLog findOneById(int $id) Return the first ChildAcctAuditLog filtered by the id column
 * @method     ChildAcctAuditLog findOneByUid(string $uid) Return the first ChildAcctAuditLog filtered by the uid column
 * @method     ChildAcctAuditLog findOneByMessage(string $message) Return the first ChildAcctAuditLog filtered by the message column
 *
 * @method     ChildAcctAuditLog[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildAcctAuditLog objects based on current ModelCriteria
 * @method     ChildAcctAuditLog[]|ObjectCollection findById(int $id) Return ChildAcctAuditLog objects filtered by the id column
 * @method     ChildAcctAuditLog[]|ObjectCollection findByUid(string $uid) Return ChildAcctAuditLog objects filtered by the uid column
 * @method     ChildAcctAuditLog[]|ObjectCollection findByMessage(string $message) Return ChildAcctAuditLog objects filtered by the message column
...
abstract class AcctAuditLogQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\Propel\\Tests\\Bookstore\\AcctAuditLog', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = AcctAuditLogTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            AcctAuditLogTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildAcctAuditLogQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(AcctAuditLogTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(AcctAuditLogTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AcctAuditLogTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByUid($uid = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AcctAuditLogTableMap::COL_UID, $uid, $comparison);
    }
    ...
    public function filterByMessage($message = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AcctAuditLogTableMap::COL_MESSAGE, $message, $comparison);
    }
     ...
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildAcctAuditLogQuery The current query, for fluid interface
     */
