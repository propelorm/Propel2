 ...
 *
 * @method     ChildTable14 findOne(ConnectionInterface $con = null) Return the first ChildTable14 matching the query
 ...
 *
 * @method     ChildTable14 findOneById(int $id) Return the first ChildTable14 filtered by the id column
 * @method     ChildTable14 findOneByTitle(string $title) Return the first ChildTable14 filtered by the title column
 * @method     ChildTable14 findOneByUrl(string $url) Return the first ChildTable14 filtered by the url column
 *
 * @method     ChildTable14[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildTable14 objects based on current ModelCriteria
 * @method     ChildTable14[]|ObjectCollection findById(int $id) Return ChildTable14 objects filtered by the id column
 * @method     ChildTable14[]|ObjectCollection findByTitle(string $title) Return ChildTable14 objects filtered by the title column
 * @method     ChildTable14[]|ObjectCollection findByUrl(string $url) Return ChildTable14 objects filtered by the url column
...
abstract class Table14Query extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'bookstore-behavior', $modelName = '\\Propel\\Tests\\Bookstore\\Behavior\\Table14', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = Table14TableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            Table14TableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildTable14Query The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(Table14TableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(Table14TableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(Table14TableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(Table14TableMap::COL_TITLE, $title, $comparison);
    }
    ...
    public function filterByUrl($url = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(Table14TableMap::COL_URL, $url, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(Table14TableMap::COL_URL, $slug, Criteria::EQUAL);
    }
