...
class Book2TableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Map.Book2TableMap';
     ...
     */
    const TABLE_NAME = 'book2';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Book2';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Book2';
     ...
     */
    const COL_ID = 'book2.ID';

    /**
     * the column name for the TITLE field
     */
    const COL_TITLE = 'book2.TITLE';

    /**
     * the column name for the STYLE field
     */
    const COL_STYLE = 'book2.STYLE';

    /**
     * the column name for the TAGS field
     */
    const COL_TAGS = 'book2.TAGS';
    ...
    const COL_STYLE_NOVEL = 'novel';
    const COL_STYLE_ESSAY = 'essay';
    const COL_STYLE_POETRY = 'poetry';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Style', 'Tags', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'title', 'style', 'tags', ),
        self::TYPE_COLNAME       => array(Book2TableMap::COL_ID, Book2TableMap::COL_TITLE, Book2TableMap::COL_STYLE, Book2TableMap::COL_TAGS, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_TITLE', 'COL_STYLE', 'COL_TAGS', ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'style', 'tags', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Style' => 2, 'Tags' => 3, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'title' => 1, 'style' => 2, 'tags' => 3, ),
        self::TYPE_COLNAME       => array(Book2TableMap::COL_ID => 0, Book2TableMap::COL_TITLE => 1, Book2TableMap::COL_STYLE => 2, Book2TableMap::COL_TAGS => 3, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_TITLE' => 1, 'COL_STYLE' => 2, 'COL_TAGS' => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'style' => 2, 'tags' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );

    /** The enumerated values for this table */
    protected static $enumValueSets = array(
                Book2TableMap::COL_STYLE => array(
    ...
    public function initialize()
    {
        ...
        $this->getColumn('STYLE', false)->setValueSet(array (
  0 => 'novel',
  1 => 'essay',
  2 => 'poetry',
));
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(Book2TableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(Book2TableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new Book2TableMap());
        }
    }
