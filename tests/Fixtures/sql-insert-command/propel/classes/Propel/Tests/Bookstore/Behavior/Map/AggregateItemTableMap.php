...
class AggregateItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.AggregateItemTableMap';
     ...
     */
    const TABLE_NAME = 'aggregate_item';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\AggregateItem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.AggregateItem';
     ...
     */
    const COL_ID = 'aggregate_item.ID';

    /**
     * the column name for the SCORE field
     */
    const COL_SCORE = 'aggregate_item.SCORE';

    /**
     * the column name for the POLL_ID field
     */
    const COL_POLL_ID = 'aggregate_item.POLL_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Score', 'PollId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'score', 'pollId', ),
        self::TYPE_COLNAME       => array(AggregateItemTableMap::COL_ID, AggregateItemTableMap::COL_SCORE, AggregateItemTableMap::COL_POLL_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_SCORE', 'COL_POLL_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'score', 'poll_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Score' => 1, 'PollId' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'score' => 1, 'pollId' => 2, ),
        self::TYPE_COLNAME       => array(AggregateItemTableMap::COL_ID => 0, AggregateItemTableMap::COL_SCORE => 1, AggregateItemTableMap::COL_POLL_ID => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_SCORE' => 1, 'COL_POLL_ID' => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'score' => 1, 'poll_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    {
        $this->addRelation('AggregatePoll', '\\Propel\\Tests\\Bookstore\\Behavior\\AggregatePoll', RelationMap::MANY_TO_ONE, array('poll_id' => 'id', ), 'SET NULL', 'CASCADE');
    } // buildRelations()
    ...
    {
        return array(
            'aggregate_column_relation_aggregate_total_score' => array('foreign_table' => 'aggregate_poll', 'update_method' => 'updateTotalScore', 'aggregate_name' => 'TotalScore', ),
            'aggregate_column_relation_aggregate_nb_votes' => array('foreign_table' => 'aggregate_poll', 'update_method' => 'updateNbVotes', 'aggregate_name' => 'NbVotes', ),
        );
    } // getBehaviors()
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(AggregateItemTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(AggregateItemTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new AggregateItemTableMap());
        }
    }
...
} // AggregateItemTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
AggregateItemTableMap::buildTableMap();
