...
class ValidateReaderBookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.ValidateReaderBookTableMap';
     ...
     */
    const TABLE_NAME = 'validate_reader_book';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateReaderBook';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.ValidateReaderBook';
     ...
     */
    const COL_READER_ID = 'validate_reader_book.READER_ID';

    /**
     * the column name for the BOOK_ID field
     */
    const COL_BOOK_ID = 'validate_reader_book.BOOK_ID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ReaderId', 'BookId', ),
        self::TYPE_STUDLYPHPNAME => array('readerId', 'bookId', ),
        self::TYPE_COLNAME       => array(ValidateReaderBookTableMap::COL_READER_ID, ValidateReaderBookTableMap::COL_BOOK_ID, ),
        self::TYPE_RAW_COLNAME   => array('COL_READER_ID', 'COL_BOOK_ID', ),
        self::TYPE_FIELDNAME     => array('reader_id', 'book_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ReaderId' => 0, 'BookId' => 1, ),
        self::TYPE_STUDLYPHPNAME => array('readerId' => 0, 'bookId' => 1, ),
        self::TYPE_COLNAME       => array(ValidateReaderBookTableMap::COL_READER_ID => 0, ValidateReaderBookTableMap::COL_BOOK_ID => 1, ),
        self::TYPE_RAW_COLNAME   => array('COL_READER_ID' => 0, 'COL_BOOK_ID' => 1, ),
        self::TYPE_FIELDNAME     => array('reader_id' => 0, 'book_id' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        $this->addRelation('ValidateReader', '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateReader', RelationMap::MANY_TO_ONE, array('reader_id' => 'id', ), null, null);
        $this->addRelation('ValidateBook', '\\Propel\\Tests\\Bookstore\\Behavior\\ValidateBook', RelationMap::MANY_TO_ONE, array('book_id' => 'id', ), null, null);
    } // buildRelations()
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'reader_id','validator' => 'NotNull',), 'rule2' => array ('column' => 'book_id','validator' => 'NotNull',), 'rule3' => array ('column' => 'reader_id','validator' => 'Type','options' => array ('type' => 'integer',),), 'rule4' => array ('column' => 'book_id','validator' => 'Type','options' => array ('type' => 'integer',),), ),
        );
    } // getBehaviors()
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getReaderId(), (string) $obj->getBookId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Propel\Tests\Bookstore\Behavior\ValidateReaderBook) {
                $key = serialize(array((string) $value->getReaderId(), (string) $value->getBookId()));
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('ReaderId', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ValidateReaderBookTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ValidateReaderBookTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ValidateReaderBookTableMap());
        }
    }
...
} // ValidateReaderBookTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
ValidateReaderBookTableMap::buildTableMap();
