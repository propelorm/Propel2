 ...
 *
 */
class BookstoreManager extends BookstoreEmployee
{

    /**
     * Constructs a new BookstoreManager class, setting the class_key column to BookstoreEmployeeTableMap::CLASSKEY_1.
     */
    public function __construct()
    {
        parent::__construct();
        $this->setClassKey(BookstoreEmployeeTableMap::CLASSKEY_1);
    }
