...
class TableWithScopeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Tests.Bookstore.Behavior.Map.TableWithScopeTableMap';
     ...
     */
    const TABLE_NAME = 'table_with_scope';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Propel\\Tests\\Bookstore\\Behavior\\TableWithScope';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Tests.Bookstore.Behavior.TableWithScope';
     ...
     */
    const COL_ID = 'table_with_scope.ID';

    /**
     * the column name for the SCOPE field
     */
    const COL_SCOPE = 'table_with_scope.SCOPE';

    /**
     * the column name for the TITLE field
     */
    const COL_TITLE = 'table_with_scope.TITLE';

    /**
     * the column name for the SLUG field
     */
    const COL_SLUG = 'table_with_scope.SLUG';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Scope', 'Title', 'Slug', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'scope', 'title', 'slug', ),
        self::TYPE_COLNAME       => array(TableWithScopeTableMap::COL_ID, TableWithScopeTableMap::COL_SCOPE, TableWithScopeTableMap::COL_TITLE, TableWithScopeTableMap::COL_SLUG, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID', 'COL_SCOPE', 'COL_TITLE', 'COL_SLUG', ),
        self::TYPE_FIELDNAME     => array('id', 'scope', 'title', 'slug', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Scope' => 1, 'Title' => 2, 'Slug' => 3, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'scope' => 1, 'title' => 2, 'slug' => 3, ),
        self::TYPE_COLNAME       => array(TableWithScopeTableMap::COL_ID => 0, TableWithScopeTableMap::COL_SCOPE => 1, TableWithScopeTableMap::COL_TITLE => 2, TableWithScopeTableMap::COL_SLUG => 3, ),
        self::TYPE_RAW_COLNAME   => array('COL_ID' => 0, 'COL_SCOPE' => 1, 'COL_TITLE' => 2, 'COL_SLUG' => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'scope' => 1, 'title' => 2, 'slug' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    {
        return array(
            'sluggable' => array('slug_column' => 'slug', 'slug_pattern' => '', 'replace_pattern' => '/\W+/', 'replacement' => '-', 'separator' => '-', 'permanent' => 'false', 'scope_column' => 'scope', ),
        );
    } // getBehaviors()
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(TableWithScopeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(TableWithScopeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new TableWithScopeTableMap());
        }
    }
...
} // TableWithScopeTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
TableWithScopeTableMap::buildTableMap();
