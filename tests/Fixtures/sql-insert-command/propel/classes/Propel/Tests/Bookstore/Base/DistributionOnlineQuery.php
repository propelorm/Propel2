 ...
 *
 */
class DistributionOnlineQuery extends DistributionStoreQuery
{

    /**
     * Returns a new \Propel\Tests\Bookstore\DistributionOnlineQuery object.
     *
    ...
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        ...
        $query = new \Propel\Tests\Bookstore\DistributionOnlineQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only DistributionOnline objects.
     */
    public function preSelect(ConnectionInterface $con)
    {
        $this->addUsingAlias(DistributionTableMap::COL_TYPE, DistributionTableMap::CLASSKEY_23);
    }
     ...
     * Having the DistributionOnline class.
