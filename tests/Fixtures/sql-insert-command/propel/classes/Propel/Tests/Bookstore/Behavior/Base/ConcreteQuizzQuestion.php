...
abstract class ConcreteQuizzQuestion implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Bookstore\\Behavior\\Map\\ConcreteQuizzQuestionTableMap';
     ...
     *
     * @return $this|ConcreteQuizzQuestion The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\Tests\Bookstore\Behavior\ConcreteQuizzQuestion The current object (for fluent API support)
     */
    ...
    {
        $pos = ConcreteQuizzQuestionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ConcreteQuizzQuestion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ConcreteQuizzQuestion'][$this->getPrimaryKey()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Bookstore\Behavior\ConcreteQuizzQuestion
     */
     ...
     *
     * @return $this|\Propel\Tests\Bookstore\Behavior\ConcreteQuizzQuestion The current object, for fluid interface
     */
