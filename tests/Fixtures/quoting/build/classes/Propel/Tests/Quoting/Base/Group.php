...
abstract class Group implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Quoting\\Map\\GroupTableMap';
    ...
    /**
     * Initializes internal state of Propel\Tests\Quoting\Base\Group object.
     */
     ...
     * @return $this|\Propel\Tests\Quoting\Group The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [by] column.
     *
     * @param  string $v new value
     * @return $this|\Propel\Tests\Quoting\Group The current object (for fluent API support)
     */
    public function setBy($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->by !== $v) {
            $this->by = $v;
            $this->modifiedColumns[GroupTableMap::COL_BY] = true;
        }
    ...
    /**
     * Set the value of [as] column.
     *
     * @param  int $v new value
     * @return $this|\Propel\Tests\Quoting\Group The current object (for fluent API support)
     */
    public function setAs($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->as !== $v) {
            $this->as = $v;
            $this->modifiedColumns[GroupTableMap::COL_AS] = true;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[GroupTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupTableMap::translateFieldName('By', TableMap::TYPE_PHPNAME, $indexType)];
            $this->by = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GroupTableMap::translateFieldName('As', TableMap::TYPE_PHPNAME, $indexType)];
            $this->as = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : GroupTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Tests\\Quoting\\Group'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GroupTableMap::COL_BY)) {
            $modifiedColumns[':p' . $index++]  = '`by`';
        }
        if ($this->isColumnModified(GroupTableMap::COL_AS)) {
            $modifiedColumns[':p' . $index++]  = '`as`';
        }
        if ($this->isColumnModified(GroupTableMap::COL_AUTHOR_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`title`':
                        ...
                        break;
                    case '`by`':
                        $stmt->bindValue($identifier, $this->by, PDO::PARAM_STR);
                        break;
                    case '`as`':
                        $stmt->bindValue($identifier, $this->as, PDO::PARAM_INT);
                        break;
                    case '`author_id`':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Quoting\Group
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setBy($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAs($arr[$keys[3]]);
        }
     ...
     *
     * @return $this|\Propel\Tests\Quoting\Group The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupTableMap::COL_BY)) {
            $criteria->add(GroupTableMap::COL_BY, $this->by);
        }
        if ($this->isColumnModified(GroupTableMap::COL_AS)) {
            $criteria->add(GroupTableMap::COL_AS, $this->as);
        }
        if ($this->isColumnModified(GroupTableMap::COL_AUTHOR_ID)) {
            $criteria->add(GroupTableMap::COL_AUTHOR_ID, $this->author_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Tests\Quoting\Group (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBy($this->getBy());
        $copyObj->setAs($this->getAs());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Tests\Quoting\Group Clone of current object.
     * @throws PropelException
     */
