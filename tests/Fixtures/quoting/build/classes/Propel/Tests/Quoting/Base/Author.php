...
/**
 * Base class that represents a row from the 'quoting_author' table.
 *
 *
 *
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Quoting\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of Propel\Tests\Quoting\Base\Author object.
     */
     ...
     * @return $this|\Propel\Tests\Quoting\Author The current object (for fluent API support)
     */
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[AuthorTableMap::COL_TYPE_ID] = true;
        }

        if ($this->aAuthorType !== null && $this->aAuthorType->getId() !== $v) {
            $this->aAuthorType = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AuthorTableMap::translateFieldName('TypeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Tests\\Quoting\\Author'), 0, $e);
        }
    }
    ...
    {
        if ($this->aAuthorType !== null && $this->type_id !== $this->aAuthorType->getId()) {
            $this->aAuthorType = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aAuthorType !== null) {
                if ($this->aAuthorType->isModified() || $this->aAuthorType->isNew()) {
                    $affectedRows += $this->aAuthorType->save($con);
                }
                $this->setAuthorType($this->aAuthorType);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AuthorTableMap::COL_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'type_id';
        }

        $sql = sprintf(
            'INSERT INTO quoting_author (%s) VALUES (%s)',
            ...
            if (null !== $this->aAuthorType) {
                ...
                switch ($keyType) {
                    ...
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'quoting_author_type';
                        break;
                    default:
                        $key = 'AuthorType';
                }

                $result[$key] = $this->aAuthorType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Quoting\Author
     */
     ...
     *
     * @return $this|\Propel\Tests\Quoting\Author The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthorTableMap::COL_TYPE_ID)) {
            $criteria->add(AuthorTableMap::COL_TYPE_ID, $this->type_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Tests\Quoting\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Tests\Quoting\Author Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildAuthorType object.
     *
     * @param  ChildAuthorType $v
     * @return $this|\Propel\Tests\Quoting\Author The current object (for fluent API support)
     * @throws PropelException
     */
    public function setAuthorType(ChildAuthorType $v = null)
    {
        if ($v === null) {
            $this->setTypeId(NULL);
        } else {
        ...
        // If this object has already been added to the ChildAuthorType object, it will not be re-added.
        if ($v !== null) {
            $v->addAuthor($this);
        }
    ...
    /**
     * Get the associated ChildAuthorType object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildAuthorType The associated ChildAuthorType object.
     * @throws PropelException
     */
    public function getAuthorType(ConnectionInterface $con = null)
    {
        if ($this->aAuthorType === null && ($this->type_id !== null)) {
            $this->aAuthorType = ChildAuthorTypeQuery::create()->findPk($this->type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthorType->addAuthors($this);
             */
        }

        return $this->aAuthorType;
    }
    ...
    public function initGroups($overrideExisting = true)
    {
        ...
        $this->collGroups->setModel('\Propel\Tests\Quoting\Group');
    }
    ...
    {
        if (null !== $this->aAuthorType) {
            $this->aAuthorType->removeAuthor($this);
        }
        $this->id = null;
        $this->name = null;
        $this->type_id = null;
