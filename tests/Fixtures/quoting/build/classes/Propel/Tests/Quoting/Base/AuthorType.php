...
/**
 * Base class that represents a row from the 'quoting_author_type' table.
 *
 *
 *
* @package    propel.generator.Propel.Tests.Quoting.Base
*/
abstract class AuthorType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Tests\\Quoting\\Map\\AuthorTypeTableMap';
    ...
    /**
     * Initializes internal state of Propel\Tests\Quoting\Base\AuthorType object.
     */
    ...
    /**
     * Compares this with another <code>AuthorType</code> instance.  If
     * <code>obj</code> is an instance of <code>AuthorType</code>, delegates to
     * <code>equals(AuthorType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AuthorType The current object, for fluid interface
     */
     ...
     * @return $this|\Propel\Tests\Quoting\AuthorType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AuthorTypeTableMap::COL_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[AuthorTypeTableMap::COL_TITLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AuthorTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AuthorTypeTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = AuthorTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Tests\\Quoting\\AuthorType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAuthorTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AuthorType::setDeleted()
     * @see AuthorType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAuthorTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AuthorTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->authorsScheduledForDeletion !== null) {
                if (!$this->authorsScheduledForDeletion->isEmpty()) {
                    foreach ($this->authorsScheduledForDeletion as $author) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AuthorTypeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AuthorTypeTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AuthorTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AuthorTypeTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }

        $sql = sprintf(
            'INSERT INTO `quoting_author_type` (%s) VALUES (%s)',
    ...
    {
        $pos = AuthorTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AuthorType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AuthorType'][$this->hashCode()] = true;
        $keys = AuthorTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Tests\Quoting\AuthorType
     */
     ...
     *
     * @return $this|\Propel\Tests\Quoting\AuthorType The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AuthorTypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AuthorTypeTableMap::COL_ID)) {
            $criteria->add(AuthorTypeTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AuthorTypeTableMap::COL_TITLE)) {
            $criteria->add(AuthorTypeTableMap::COL_TITLE, $this->title);
        }
    ...
    {
        $criteria = ChildAuthorTypeQuery::create();
        $criteria->add(AuthorTypeTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Tests\Quoting\AuthorType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Tests\Quoting\AuthorType Clone of current object.
     * @throws PropelException
     */
    ...
    public function initAuthors($overrideExisting = true)
    {
        ...
        $this->collAuthors = new ObjectCollection();
        $this->collAuthors->setModel('\Propel\Tests\Quoting\Author');
    }
     ...
     * If this ChildAuthorType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAuthorType The current object (for fluent API support)
     */
    public function setAuthors(Collection $authors, ConnectionInterface $con = null)
    {
        ...
        foreach ($authorsToDelete as $authorRemoved) {
            $authorRemoved->setAuthorType(null);
        }
