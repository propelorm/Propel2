...
abstract class ModelTestCase extends TestCase
{
    ...
    protected function getRelationMock($name = null, array $options = array())
    {
        ...
        $fk
            ...
            ->will($this->returnValue($options['foreign_entity_name']))
        ;
     ...
     * @return Index
     */
    protected function getIndexMock($name = null)
    {
        $index = $this
    ...
    {
        $defaults = array(
            'sql_name'    => NamingTool::toUnderscore($name),
            'namespace'   => null,
            'database'    => null,
            'platform'    => null,
            'behaviors'   => array(),
        ...
        $entity
            ->expects($this->any())
            ->method('getSqlName')
            ->will($this->returnValue($options['sql_name']))
        ;
    ...
    protected function getFieldMock($name, array $options = array())
    {
        ...
        $column
            ->expects($this->any())
            ->method('getName')
            ->will($this->returnValue(NamingTool::toCamelCase($name)))
        ;
