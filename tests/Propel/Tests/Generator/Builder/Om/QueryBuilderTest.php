...
class QueryBuilderTest extends BookstoreTestBase
{
    ...
    public function testFilterByPrimaryKeySimpleKey()
    {
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_ID, 12, Criteria::EQUAL);
    ...
    public function testFilterByPrimaryKeyCompositeKey()
    {
        ...
        $q1 = BookListRelQuery::create()
            ->add(BookListRelTableMap::FIELD_BOOK_ID, $pk[0], Criteria::EQUAL)
            ->add(BookListRelTableMap::FIELD_BOOK_CLUB_LIST_ID, $pk[1], Criteria::EQUAL);
    ...
    public function testFilterByPrimaryKeysSimpleKey()
    {
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_ID, array(10, 11, 12), Criteria::IN);
    ...
    public function testFilterByPrimaryKeysCompositeKey()
    {
        ...
        foreach ($search as $key) {
            $cton0 = $q1->getNewCriterion(BookListRelTableMap::FIELD_BOOK_ID, $key[0], Criteria::EQUAL);
            $cton1 = $q1->getNewCriterion(BookListRelTableMap::FIELD_BOOK_CLUB_LIST_ID, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $q1->addOr($cton0);
        }
    ...
    public function testFilterByIntegerPk()
    {
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_ID, 12, Criteria::NOT_EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_ID, array(10, 11, 12), Criteria::NOT_IN);
    ...
    public function testFilterByNumber()
    {
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_PRICE, 12, Criteria::EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_PRICE, 12, Criteria::NOT_EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_PRICE, array(10, 11, 12), Criteria::IN);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_PRICE, array(10, 11, 12), Criteria::NOT_IN);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_PRICE, 10, Criteria::GREATER_EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_PRICE, 12, Criteria::LESS_EQUAL);
        ...
        $q1 = BookQuery::create()
            ->add(BookTableMap::FIELD_PRICE, 10, Criteria::GREATER_EQUAL)
            ->addAnd(BookTableMap::FIELD_PRICE, 12, Criteria::LESS_EQUAL);
    ...
    public function testFilterByTimestamp()
    {
        ...
        $q1 = BookstoreEmployeeAccountQuery::create()->add(BookstoreEmployeeAccountTableMap::FIELD_CREATED, 12, Criteria::EQUAL);
        ...
        $q1 = BookstoreEmployeeAccountQuery::create()->add(BookstoreEmployeeAccountTableMap::FIELD_CREATED, 12, Criteria::NOT_EQUAL);
        ...
        $q1 = BookstoreEmployeeAccountQuery::create()->add(BookstoreEmployeeAccountTableMap::FIELD_CREATED, 10, Criteria::GREATER_EQUAL);
        ...
        $q1 = BookstoreEmployeeAccountQuery::create()->add(BookstoreEmployeeAccountTableMap::FIELD_CREATED, 12, Criteria::LESS_EQUAL);
        ...
        $q1 = BookstoreEmployeeAccountQuery::create()
            ->add(BookstoreEmployeeAccountTableMap::FIELD_CREATED, 10, Criteria::GREATER_EQUAL)
            ->addAnd(BookstoreEmployeeAccountTableMap::FIELD_CREATED, 12, Criteria::LESS_EQUAL);
    ...
    public function testFilterByString()
    {
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, 'foo', Criteria::EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, 'foo', Criteria::NOT_EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, array('foo', 'bar'), Criteria::IN);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, array('foo', 'bar'), Criteria::NOT_IN);
        $this->assertEquals($q1, $q, 'filterByStringColumn() accepts a comparison when passed an array');

        $q = BookQuery::create()->filterByTitle('foo%');
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, 'foo%', Criteria::LIKE);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, 'foo%', Criteria::NOT_LIKE);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_TITLE, '%f%o%o%', Criteria::LIKE);
    ...
    public function testFilterByBoolean()
    {
        ...
        $q1 = ReviewQuery::create()->add(ReviewTableMap::FIELD_RECOMMENDED, true, Criteria::EQUAL);
        ...
        $q1 = ReviewQuery::create()->add(ReviewTableMap::FIELD_RECOMMENDED, true, Criteria::NOT_EQUAL);
        ...
        $q1 = ReviewQuery::create()->add(ReviewTableMap::FIELD_RECOMMENDED, false, Criteria::EQUAL);
        $this->assertEquals($q1, $q, 'filterByBooleanColumn() translates to a Criteria::EQUAL by default');
    ...
    public function testFilterByFkSimpleKey()
    {
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_AUTHOR_ID, $testAuthor->getId(), Criteria::EQUAL);
        ...
        $q1 = BookQuery::create()->add(BookTableMap::FIELD_AUTHOR_ID, $testAuthor->getId(), Criteria::NOT_EQUAL);
    ...
    public function testFilterByFkObjectCollection()
    {
        ...
        $books = BookQuery::create()
            ->add(BookTableMap::FIELD_AUTHOR_ID, $authors->getPrimaryKeys(), Criteria::IN)
            ->find($this->con);
    ...
    public function testFilterByRefFkSimpleKey()
    {
        ...
        $q1 = AuthorQuery::create()->add(AuthorTableMap::FIELD_ID, $testBook->getAuthorId(), Criteria::EQUAL);
        ...
        $q1 = AuthorQuery::create()->add(AuthorTableMap::FIELD_ID, $testBook->getAuthorId(), Criteria::NOT_EQUAL);
    ...
    public function testFilterByRelationNameCompositePk()
    {
        ...
        $testRelease = ReleasePoolQuery::create()
            ->addJoin(ReleasePoolTableMap::FIELD_RECORD_LABEL_ID, RecordLabelTableMap::FIELD_ID)
        ...
        $releasePool = ReleasePoolQuery::create()
            ->addJoin(ReleasePoolTableMap::FIELD_RECORD_LABEL_ID, RecordLabelTableMap::FIELD_ID)
            ->add(ReleasePoolTableMap::FIELD_RECORD_LABEL_ID, $testLabel->toKeyValue('Id', 'Id'), Criteria::IN)
            ->find($this->con);
        $q2 = $this->con->getLastExecutedQuery();
    ...
    public function testFilterByRefFkObjectCollection()
    {
        ...
        $authors = AuthorQuery::create()
            ->addJoin(AuthorTableMap::FIELD_ID, BookTableMap::FIELD_AUTHOR_ID, Criteria::LEFT_JOIN)
            ->add(BookTableMap::FIELD_ID, $books->getPrimaryKeys(), Criteria::IN)
            ->find($this->con);
        $q2 = $this->con->getLastExecutedQuery();
    ...
    public function testUseFkQuerySimple()
    {
        ...
        $q1 = BookQuery::create()
            ->join('Book.Author', Criteria::LEFT_JOIN)
            ->add(AuthorTableMap::FIELD_FIRST_NAME, 'Leo', Criteria::EQUAL);
        ...
        $q1 = BookSummaryQuery::create()
            ->join('BookSummary.SummarizedBook', Criteria::INNER_JOIN)
            ->add(BookTableMap::FIELD_TITLE, 'War And Peace', Criteria::EQUAL);
    ...
    public function testUseFkQueryTwice()
    {
        ...
        $q1 = BookQuery::create()
            ->join('Book.Author', Criteria::LEFT_JOIN)
            ->add(AuthorTableMap::FIELD_FIRST_NAME, 'Leo', Criteria::EQUAL)
            ->add(AuthorTableMap::FIELD_LAST_NAME, 'Tolstoi', Criteria::EQUAL);
    ...
    public function testUseFkQueryTwoRelations()
    {
        ...
        $q1 = BookQuery::create()
            ...
            ->add(PublisherTableMap::FIELD_NAME, 'Penguin', Criteria::EQUAL);
