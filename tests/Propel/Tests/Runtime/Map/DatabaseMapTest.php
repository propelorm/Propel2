...
class DatabaseMapTest extends BookstoreTestBase
{
  ...
  {
        $this->assertEquals('book', Configuration::getInstance()->getDatabaseMap('bookstore')->getTableByPhpName('Propel\Tests\Bookstore\Book')->getName(), 'getTableByPhpName() can autoload a TableMap when the Peer class is generated and autoloaded');
  }
