...
class PropelObjectCollectionWithFixturesTest extends BookstoreEmptyTestBase
{
	...
	public function testPopulateRelation()
	{
		...
		$books = $authors->populateRelation('\Propel\Tests\Bookstore\Book');
	...
	public function testPopulateRelationCriteria()
	{
		...
		$c = new Criteria();
		$c->setLimit(3);
		$books = $authors->populateRelation('\Propel\Tests\Bookstore\Book', $c);
	...
	public function testPopulateRelationEmpty()
	{
		...
		$books = $authors->populateRelation('\Propel\Tests\Bookstore\Book', null, $this->con);
		$this->assertTrue($books instanceof PropelObjectCollection, 'populateRelation() returns a PropelCollection instance');
		$this->assertEquals('\Propel\Tests\Bookstore\Book', $books->getModel(), 'populateRelation() returns a collection of the related objects');
