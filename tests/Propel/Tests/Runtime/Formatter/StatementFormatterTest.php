...
class StatementFormatterTest extends BookstoreEmptyTestBase
{
    ...
    public function testFormatManyResults()
    {
        ...
        $this->assertTrue($books->getDataObject() instanceof PDOStatement, 'StatementFormatter::format() returns a PDOStatement');
    ...
    public function testFormatOneManyResults()
    {
        ...
        $this->assertTrue($book instanceof PDODataFetcher, 'StatementFormatter::formatOne() returns a PDODataFetcher');
    }
